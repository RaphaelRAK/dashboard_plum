...
export const HomePage: React.FC = () => {
    ...
    const [selectedChart, setSelectedChart] = useState<keyof typeof chartDescriptions>('orderEvolution');

    // Description des graphiques
    const chartDescriptions = {
        orderEvolution: "Graphique montrant l'évolution des commandes au fil du temps.",
        // conversionRate: "Graphique montrant le taux de conversion des recherches en commandes.",
        searchAndOrders: "Graphique combinant les recherches et les commandes pour une période donnée.",
        claimAndOrder: "Graphique combinant les réclamations et les commandes pour une période donnée.",
    };
                ...
                <div style={{ width: '60%', marginLeft: '20px' }}>
                    <div style={{ marginBottom: '20px' }}>
                        <Select
                            ...
                            style={{ width: 300 }}
                            onChange={(value: "orderEvolution" | "searchAndOrders") => setSelectedChart(value)}
                        >
